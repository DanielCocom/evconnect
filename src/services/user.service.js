...
class UserService {
  static async createUser(data) {
    ...
    const nfc_uid = await generateNfcUid(); // Genera un UID único para el usuario // 3. Crear customer en Stripe ANTES de crear el usuario
    ...
    try {
      ...
      console.error("Error creando customer en Stripe:", stripeError); // Es un proyecto escolar: si Stripe falla, continuamos pero el usuario no podrá pagar.
